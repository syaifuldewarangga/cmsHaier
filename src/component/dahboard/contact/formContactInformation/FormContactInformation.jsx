...
const FormContactInformation = (props) => {
    ...
    const getContactInformationDataFromAPI = async () => {
        ...
        .then((res) => {
            ...
            setContactInformationData(res.data.content)
        })
    }
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append('content', contactInformationData)
        await axios.put(props.base_url + 'contact-information', formData, {
            headers: {
                Authorization: 'Bearer ' + token,
            },
        }).then((res) => {
            alert('berhasil')
            history.push('/setting/contact-information')
        }).catch((err) => {
                            ...
                            <div className="col-lg-12 mb-3">
                                <CKEditor
                                    ...
                                    onChange={(event, editor) => {
                                        ...
                                        setContactInformationData(value);
                                    }}
                                    onBlur={(event, editor) => {
...
export default  connect(mapStateToProps, null) (FormContactInformation)