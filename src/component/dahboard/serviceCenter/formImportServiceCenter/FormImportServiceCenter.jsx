...
const FormImportServiceCenter = (props) => {
  ...
  const uploadExcel = async (event) => {
    ...
    const request = await axios
      .post(props.base_url + 'service-center/import', fileFormdata, {
        headers: {
...
export default connect(mapStateToProps, null)(FormImportServiceCenter);
